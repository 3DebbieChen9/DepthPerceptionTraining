...
public class PunchCollectingManager : MonoBehaviour
{
    [SerializeField]
    ...
    void Update()
    {
        ...
        {
            this.reloadPunchCollectingScene();
        }
    }
    ...
    public void reloadPunchCollectingScene()
    {
        this.mainManager.changeScene("PunchCollectingScene");
    }

    public UserArmStraightAngle calculateNewStraightStandardAngle()
    {
